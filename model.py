...
conv1 = Convolution2D(32,3,3,border_mode='same', W_regularizer=l1(wr), init='lecun_uniform')
conv_l1 = conv1(frame_in)
Econv_l1 = ELU()(conv_l1)
pool_l1 = MaxPooling2D(pool_size=(2,2))(Econv_l1)

conv2 = Convolution2D(32,3,3,border_mode='same', W_regularizer=l1(wr), init='lecun_uniform')
conv_l2 = conv2(pool_l1)
Econv_l2 = ELU()(conv_l2)
pool_l2 = MaxPooling2D(pool_size=(2,2))(Econv_l2)
drop_l2 = Dropout(dp)(pool_l2)

conv3 = Convolution2D(64,3,3,border_mode='same', W_regularizer=l1(wr), init='lecun_uniform')
...
D1 = Dense(512,W_regularizer=l1(wr), init='lecun_uniform')(flat)
ED1 = ELU()(D1)
DED1 = Dropout(dp)(ED1)
...
OUT = Dense(10, activation='softmax', name='out', init='lecun_uniform')(ES1)
